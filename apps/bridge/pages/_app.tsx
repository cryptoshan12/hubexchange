  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Cheaper and faster than Uniswap? Discover Hub.Exchange, the leading DEX on BNB Smart Chain (BSC) with the best farms in DeFi and a lottery for CAKE."
        />
        <meta name="theme-color" content="#3B82F6" />
        <meta name="twitter:image" content="https://hub.exchange/images/hero.png" />
        <meta
        ...
        <meta name="twitter:title" content="🥞 Hub.Exchange - A next evolution DeFi exchange on BNB Smart Chain (BSC)" />
        <title>Hub.Exchange Bridge</title>
      </Head>
      <NextThemeProvider>
        <StyledThemeProvider>
          <ModalProvider>
