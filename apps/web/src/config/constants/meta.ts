...
export const DEFAULT_META: PageMeta = {
  ...
  image: 'https://hub.exchange/images/hero.png',
}
...
const getPathList = (t: ContextApi['t']): PathList => {
  return {
    paths: {
      ...
      '/info': { title: t('Overview'), description: 'View statistics for Hub.Exchange exchanges.' },
      '/info/pairs': { title: t('Pairs'), description: 'View statistics for Hub.Exchange exchanges.' },
      '/info/tokens': { title: t('Tokens'), description: 'View statistics for Hub.Exchange exchanges.' },
    ...
    defaultTitleSuffix: t('Hub.Exchange'),
  }
}
