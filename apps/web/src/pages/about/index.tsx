  ...
  return (
    <div style={{ fontFamily: "Arial, sans-serif", backgroundColor: "#f8fafc", padding: "20px" }}>
      ...
      <div style={{ marginTop: "30px", padding: "20px" }}>
        <h2 style={{ textAlign: "center", color: vars.colors.contrast, fontSize: "24px", fontWeight: "bold", maxWidth: "800px", margin: "0 auto", marginBottom: "20px" }}>
        ...
        >
          {[
            ...
            >
              <h3 style={{ fontSize: "18px", fontWeight: "bold", marginBottom: "10px", color: vars.colors.contrast }}>
                {feature.title}
              </h3>
              <p style={{ fontSize: "14px", color: vars.colors.textSubtle }}>
                {feature.description}
              </p>
            </div>
          ))}
      ...
      <div style={{ maxWidth: "800px", margin: "30px auto", textAlign: "left", padding: "20px" }}>
        <h2 style={{ fontSize: "22px", fontWeight: "bold", color: vars.colors.contrast }}>
          Why Choose Us?
        </h2>
      ...
      >
        ...
        <p style={{ fontSize: "16px" }}>
          Provide liquidity and earn fees every time someone swaps on YourDEX
        </p>
      </div>
    </div>
  );
