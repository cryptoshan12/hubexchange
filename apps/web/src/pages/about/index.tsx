  ...
  return (
    <div style={{ fontFamily: "Arial, sans-serif", backgroundColor: "#f8fafc", padding: "30px" }}>
      ...
      <div style={{ marginTop: "30px", padding: "30px" }}>
        <h2 style={{ textAlign: "center", fontSize: "32px", fontWeight: "bold", maxWidth: "800px", margin: "0 auto", marginBottom: "30px" }}>
      ...
      <div style={{ maxWidth: "800px", margin: "50px auto", textAlign: "left", padding: "30px" }}>
        ...
        <ul style={{ listStyle: "none", padding: 0 }}>
          {[
            ...
            <li key={reason.id} style={{ backgroundColor: "#fff", padding: "10px", margin: "5px 0", borderRadius: "8px", boxShadow: "0px 2px 4px rgba(0, 0, 0, 0.1)" }}>
              {reason.text}
            </li>
          ))}
        </ul>
